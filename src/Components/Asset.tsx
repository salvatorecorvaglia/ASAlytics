...
import { getCoinHistoricalData, getCoinInfo } from "../CoinGeckoAPI/fetch";
import { numberToString } from "../Utils/numberUtils";
import { CoinInfo } from "../Models/coin";
import { CanvasPoint, HistoricalData, Period } from "../Models/graph";
