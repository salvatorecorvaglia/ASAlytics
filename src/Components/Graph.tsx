...
import { getGraphConfig } from "../Utils/graphUtils";
import { numberWithSignificantDigits } from "../Utils/numberUtils";
import { ChangeSince24H } from "../Models/coin";
import { CanvasPoint, HistoricalValue, Period } from "../Models/graph";
  ...
  if (!values || !period) {
    return (
      <div className="relative non-select" style={{ height: height + 24 }}>
        <Frame width={width} height={height} loading={true}/>
      </div>
    );
  }
